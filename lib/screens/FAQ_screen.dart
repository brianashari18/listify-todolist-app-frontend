                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => FeedbackPage()), // Navigate to feedback page
                      );
                      // Handle submit bug report
                    },
                    style: ElevatedButton.styleFrom(
                      backgroundColor: Colors.white, // Button stays white
                      foregroundColor: const Color(0xFF393646), // Text matches background
  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
        ...
        border: hasBorder ? Border.all(color: Colors.black, width: 2) : null, // Add border if required
      ),
